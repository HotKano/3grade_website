...
mysql_query("set session character_set_client=utf8;");
	...
	<tr>
	<td width ='250' align='center' colspan='2' bgcolor=#95f3c3> <a href=show.php?board=customer> <b> 자유게시판 </b> </a> </td></tr>
	");
...
if (!$total){
  echo("
    <tr><td width='250' colspan=5 align=center>아직 등록된 글이 없습니다.</td></tr></table>
  ");
} else {
